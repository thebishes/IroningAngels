...
const HomePage = () => {
  ...
  const testimonials = [
    ...
    {
      quote:
        'We are regular customers and love the service.',
      author: 'Ian',
      rating: 5,
    },
    {
      quote:
        'I am retired and quite elderly, so I appreciate the pickup and drop off service.',
      author: 'Susan',
      rating: 4,
    },
  ];
      ...
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="max-w-2xl mx-auto text-center">
            <motion.h1
              className="mb-6 text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mt-4"
                ...
                <ol className="space-y-6">
                  ...
                  <li className="flex">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Optional pickup and drop-off service from your home or office within a 10 mile range of NG19. £ Charges apply.
                      </p>
                    </div>
                  </li>
                  <li className="flex">
