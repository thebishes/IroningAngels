...
import { Shirt, Mail, Phone, MapPin, Clock } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="font-semibold text-lg">Ironing Angels</span>
            </div>
            <p className="text-gray-600 mb-4">
              Professional ironing services to keep your clothes looking their best.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://www.instagram.com/ironing_angels"
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-600">contact@ironingangels.uk</span>
              </li>
              <li className="flex items-start">
